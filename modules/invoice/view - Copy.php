            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong>
                        ...
                        <small>Size: <?php echo $item['size_name']; ?></small></strong>
                    </td>
                    <td class="text-center"><strong><?php echo $item['quantity']; ?></strong></td>
                    <td class="text-right"><strong><?php echo number_format($ProductAmount, 2); ?></strong></td>
                    <td class="text-center"><strong><?php echo $gstPercent; ?></td>
                    <td class="text-right"><strong><?php echo number_format($item['cgst_amount'], 2); ?></strong></td>
                    <td class="text-center"><strong><?php echo $gstPercent; ?></strong></td>
                    <td class="text-right"><strong><?php echo number_format($item['sgst_amount'], 2); ?></strong></td>
