...
$itemsSql = "SELECT 
             ...
             WHERE ii.invoice_id = ?";$itemsStmt = $conn->prepare($itemsSql);
...
<div class="print-area" id="invoice-content">
    ...
    foreach ($rowsToPrint as $printItem):
...
<tr>
    ...
    <td class="text-center">
        <strong><?php echo $gstPercent; ?></strong>
    </td>
...
?>
                ...
                <?php if($invoice['discount_amount'] > 0){ ?>
                    <tr>
                        ...
                        <td></td>
                        <td class="text-right">
                            <strong><?php echo number_format($invoice['discount_amount'],2); ?></strong>
                        </td>
                    </tr> 
