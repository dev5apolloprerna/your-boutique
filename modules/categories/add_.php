<?php
ob_start();
$pageTitle = 'Add Category - Payal Urban Stitch';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($categoryName)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO categories (category_name, sort_order, is_active) VALUES (?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param('sii', $categoryName, $sortOrder, $isActive);
